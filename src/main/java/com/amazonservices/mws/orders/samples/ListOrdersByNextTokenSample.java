...
public class ListOrdersByNextTokenSample {
     ...
     * @return The response.
     */
    public static com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse invokeListOrdersByNextToken(
        ...
        try {
            // Call the service.
            com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse response = client.listOrdersByNextToken(request);
