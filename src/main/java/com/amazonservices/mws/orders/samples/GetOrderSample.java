...
public class GetOrderSample {
     ...
     * @return The response.
     */
    public static com.amazonservices.mws.orders.model.GetOrderResponse invokeGetOrder(
        ...
        try {
            // Call the service.
            com.amazonservices.mws.orders.model.GetOrderResponse response = client.getOrder(request);
