...
public class ListOrderItemsAsyncSample {
    ...
    public static List<Object> invokeListOrderItems(
            ...
            List<com.amazonservices.mws.orders.model.ListOrderItemsRequest> requestList) {
        // Call the service async.
        List<Future<com.amazonservices.mws.orders.model.ListOrderItemsResponse>> futureList =
            new ArrayList<Future<com.amazonservices.mws.orders.model.ListOrderItemsResponse>>();
        for (com.amazonservices.mws.orders.model.ListOrderItemsRequest request : requestList) {
            Future<com.amazonservices.mws.orders.model.ListOrderItemsResponse> future =
                client.listOrderItemsAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<com.amazonservices.mws.orders.model.ListOrderItemsResponse> future : futureList) {
            Object xresponse;
            try {
                com.amazonservices.mws.orders.model.ListOrderItemsResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<com.amazonservices.mws.orders.model.ListOrderItemsRequest> requestList = new ArrayList<com.amazonservices.mws.orders.model.ListOrderItemsRequest>();
