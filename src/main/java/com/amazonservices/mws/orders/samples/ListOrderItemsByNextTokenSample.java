...
public class ListOrderItemsByNextTokenSample {
     ...
     * @return The response.
     */
    public static com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse invokeListOrderItemsByNextToken(
        ...
        try {
            // Call the service.
            com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse response = client.listOrderItemsByNextToken(request);
