...
public class ListOrdersByNextTokenAsyncSample {
    ...
    public static List<Object> invokeListOrdersByNextToken(
            ...
            List<com.amazonservices.mws.orders.model.ListOrdersByNextTokenRequest> requestList) {
        // Call the service async.
        List<Future<com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse>> futureList =
            new ArrayList<Future<com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse>>();
        for (com.amazonservices.mws.orders.model.ListOrdersByNextTokenRequest request : requestList) {
            Future<com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse> future =
                client.listOrdersByNextTokenAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse> future : futureList) {
            Object xresponse;
            try {
                com.amazonservices.mws.orders.model.ListOrdersByNextTokenResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<com.amazonservices.mws.orders.model.ListOrdersByNextTokenRequest> requestList = new ArrayList<com.amazonservices.mws.orders.model.ListOrdersByNextTokenRequest>();
        com.amazonservices.mws.orders.model.ListOrdersByNextTokenRequest request = new com.amazonservices.mws.orders.model.ListOrdersByNextTokenRequest();
