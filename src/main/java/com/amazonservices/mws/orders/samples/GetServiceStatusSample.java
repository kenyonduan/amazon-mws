...
public class GetServiceStatusSample {
     ...
     * @return The response.
     */
    public static com.amazonservices.mws.orders.model.GetServiceStatusResponse invokeGetServiceStatus(
        ...
        try {
            // Call the service.
            com.amazonservices.mws.orders.model.GetServiceStatusResponse response = client.getServiceStatus(request);
