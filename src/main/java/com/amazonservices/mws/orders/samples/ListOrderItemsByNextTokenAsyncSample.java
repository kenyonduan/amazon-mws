...
public class ListOrderItemsByNextTokenAsyncSample {
    ...
    public static List<Object> invokeListOrderItemsByNextToken(
            ...
            List<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenRequest> requestList) {
        // Call the service async.
        List<Future<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse>> futureList =
            new ArrayList<Future<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse>>();
        for (com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenRequest request : requestList) {
            Future<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse> future =
                client.listOrderItemsByNextTokenAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse> future : futureList) {
            Object xresponse;
            try {
                com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenRequest> requestList = new ArrayList<com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenRequest>();
        com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenRequest request = new com.amazonservices.mws.orders.model.ListOrderItemsByNextTokenRequest();
