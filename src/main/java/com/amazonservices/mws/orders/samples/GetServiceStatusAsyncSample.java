...
public class GetServiceStatusAsyncSample {
    ...
    public static List<Object> invokeGetServiceStatus(
            ...
            List<com.amazonservices.mws.orders.model.GetServiceStatusRequest> requestList) {
        // Call the service async.
        List<Future<com.amazonservices.mws.orders.model.GetServiceStatusResponse>> futureList =
            new ArrayList<Future<com.amazonservices.mws.orders.model.GetServiceStatusResponse>>();
        for (com.amazonservices.mws.orders.model.GetServiceStatusRequest request : requestList) {
            Future<com.amazonservices.mws.orders.model.GetServiceStatusResponse> future =
                client.getServiceStatusAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<com.amazonservices.mws.orders.model.GetServiceStatusResponse> future : futureList) {
            Object xresponse;
            try {
                com.amazonservices.mws.orders.model.GetServiceStatusResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<com.amazonservices.mws.orders.model.GetServiceStatusRequest> requestList = new ArrayList<com.amazonservices.mws.orders.model.GetServiceStatusRequest>();
        com.amazonservices.mws.orders.model.GetServiceStatusRequest request = new com.amazonservices.mws.orders.model.GetServiceStatusRequest();
