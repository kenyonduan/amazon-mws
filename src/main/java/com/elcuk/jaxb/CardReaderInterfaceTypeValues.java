...
/*    */ 
/*    */   private CardReaderInterfaceTypeValues(String v) {
/* 56 */     this.value = v;
/*    */   }
/*    */ 
/*    */   public String value() {
...
/* 64 */     for (CardReaderInterfaceTypeValues c : values()) {
 ...
 * Qualified Name:     com.elcuk.jaxb.CardReaderInterfaceTypeValues
