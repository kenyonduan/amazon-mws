...
/*     */ 
/*     */   private CompatibleMemoryCardTypeValues(String v) {
/* 137 */     this.value = v;
/*     */   }
/*     */ 
/*     */   public String value() {
...
/* 145 */     for (CompatibleMemoryCardTypeValues c : values()) {
 ...
 * Qualified Name:     com.elcuk.jaxb.CompatibleMemoryCardTypeValues
