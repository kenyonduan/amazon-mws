...
public class GetOrderSample {
     ...
     * @return The response.
     */
    public static com.amazonaws.mws.orders.model.GetOrderResponse invokeGetOrder(
            com.amazonaws.mws.orders.MarketplaceWebServiceOrders client,
            com.amazonaws.mws.orders.model.GetOrderRequest request) {
        try {
            // Call the service.
            com.amazonaws.mws.orders.model.GetOrderResponse response = client.getOrder(request);
