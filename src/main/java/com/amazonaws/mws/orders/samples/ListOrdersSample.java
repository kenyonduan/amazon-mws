...
public class ListOrdersSample {
     ...
     * @return The response.
     */
    public static com.amazonaws.mws.orders.model.ListOrdersResponse invokeListOrders(
            com.amazonaws.mws.orders.MarketplaceWebServiceOrders client,
            com.amazonaws.mws.orders.model.ListOrdersRequest request) {
        try {
            // Call the service.
            com.amazonaws.mws.orders.model.ListOrdersResponse response = client.listOrders(request);
