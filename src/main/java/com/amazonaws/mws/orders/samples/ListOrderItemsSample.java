...
public class ListOrderItemsSample {
     ...
     * @return The response.
     */
    public static com.amazonaws.mws.orders.model.ListOrderItemsResponse invokeListOrderItems(
            com.amazonaws.mws.orders.MarketplaceWebServiceOrders client,
            com.amazonaws.mws.orders.model.ListOrderItemsRequest request) {
        try {
            // Call the service.
            com.amazonaws.mws.orders.model.ListOrderItemsResponse response = client.listOrderItems(request);
