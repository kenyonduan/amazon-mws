...
public class ListOrdersAsyncSample {
    ...
    public static List<Object> invokeListOrders(
            ...
            List<com.amazonaws.mws.orders.model.ListOrdersRequest> requestList) {
        // Call the service async.
        List<Future<com.amazonaws.mws.orders.model.ListOrdersResponse>> futureList =
            new ArrayList<Future<com.amazonaws.mws.orders.model.ListOrdersResponse>>();
        for (com.amazonaws.mws.orders.model.ListOrdersRequest request : requestList) {
            Future<com.amazonaws.mws.orders.model.ListOrdersResponse> future =
                client.listOrdersAsync(request);
            futureList.add(future);
        }
        List<Object> responseList = new ArrayList<Object>();
        for (Future<com.amazonaws.mws.orders.model.ListOrdersResponse> future : futureList) {
            Object xresponse;
            try {
                com.amazonaws.mws.orders.model.ListOrdersResponse response = future.get();
    ...
    public static void main(String[] args) {
        ...
        List<com.amazonaws.mws.orders.model.ListOrdersRequest> requestList = new ArrayList<com.amazonaws.mws.orders.model.ListOrdersRequest>();
        com.amazonaws.mws.orders.model.ListOrdersRequest request = new com.amazonaws.mws.orders.model.ListOrdersRequest();
