...
public class GetServiceStatusSample {
     ...
     * @return The response.
     */
    public static com.amazonaws.mws.orders.model.GetServiceStatusResponse invokeGetServiceStatus(
        ...
        try {
            // Call the service.
            com.amazonaws.mws.orders.model.GetServiceStatusResponse response = client.getServiceStatus(request);
