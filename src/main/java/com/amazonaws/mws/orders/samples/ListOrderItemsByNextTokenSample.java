...
public class ListOrderItemsByNextTokenSample {
     ...
     * @return The response.
     */
    public static com.amazonaws.mws.orders.model.ListOrderItemsByNextTokenResponse invokeListOrderItemsByNextToken(
        ...
        try {
            // Call the service.
            com.amazonaws.mws.orders.model.ListOrderItemsByNextTokenResponse response = client.listOrderItemsByNextToken(request);
